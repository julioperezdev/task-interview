...
public class RemindersTester {
    public static void main(String[] args) {
         ...
         * Si la categoría no existe se lanza la excepción CategoryNotFoundException. * Si no hay tareas pertenecientes a la categoría devuelve una colección
         vacía.
         */
        ...
        /**
         * Obtiene todas las tareas (tanto pendientes como completadas)
         * ordenadas alfabéticamente por categoría y luego alfabéticamente * por nombre de la tarea.
